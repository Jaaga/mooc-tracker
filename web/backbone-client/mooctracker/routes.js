...
(function(){
  ...
  MC.Router = Backbone.Router.extend({
    ...
    routes: {
      ...
      // students
      'app/admin/students': 'adminStudents',
      'app/admin/students/new': 'newAdminStudent',
      'app/admin/student/:id': 'adminStudentPage'
    ...
    adminStudents: function() {
      var view = new MC.AdminStudentsView();
      $container.html('').append(view.render().$el);
      view.addAllStudentsViews();
    },

    adminStudentPage: function(id) {
      var model = MC.Students.get(id);
      var view = new MC.AdminStudentPageView({ model: model });
      $container.html('').append(view.render().$el);
      view.showStudentCourses();
      view.showStudentProjects();
    },

    newAdminStudent: function() {
      var view = new MC.AdminStudentFormView();
      $container.html('').append(view.render().$el);
    },
